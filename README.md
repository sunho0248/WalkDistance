...
- GitHub Release: https://github.com/sunho0248/WalkDistance/releases/tag/v1.3.5
...
가장 쉬운 방법은 [v1.3.5 Release](https://github.com/sunho0248/WalkDistance/releases/tag/v1.3.5)에서 `WalkDistance-win-x64.zip`를 내려받는 것입니다.
